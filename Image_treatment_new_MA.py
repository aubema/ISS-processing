...
image_msi = image_tech.copy()
# abcdaire pour montreal 2013
image_msi[image_tech == 6] = 0.017
image_msi[image_tech == 5] = 0.12
image_msi[image_tech == 4] = 0.09
image_msi[image_tech == 3] = 0.26
image_msi[image_tech == 2] = 0.44
image_msi[image_tech == 1] = 0.58


image_intensity[np.isnan(image_intensity)] = 0

image_impact = image_intensity * image_msi
...
save_geotiff(p["wd"] + "/msi", image_msi)
save_geotiff(p["wd"] + "/impact", image_impact)
